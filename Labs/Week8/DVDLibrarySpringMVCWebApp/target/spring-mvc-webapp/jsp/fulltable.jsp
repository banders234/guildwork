            ...
            <table class="table">
                ...
                <c:forEach items="${dvds}" var="dvd">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/dvd/show?id=${dvd.id}">Show</a></td>
                        <td><a href="${pageContext.request.contextPath}/dvd/edit?id=${dvd.id}">Edit</a></td>
                        <td><a href="${pageContext.request.contextPath}/dvd/delete?id=${dvd.id}">Delete</a></td> 
                    </tr>
                </c:forEach>
                <div>
                    ${emptyMessage}
