 ...
 * @author apprentice
 */
public class AddressDaoObImpl implements AddressDao {
    ...
    private static final String SQL_SEARCH_ADDRESS_LAST_NAME = "SELECT * FROM address WHERE last_name LIKE ?";
    private static final String SQL_SEARCH_ADDRESS_CITY = "SELECT * FROM address WHERE city = ?";
    private static final String SQL_SEARCH_ADDRESS_STATE = "SELECT * FROM address WHERE state = ?";
    private static final String SQL_SEARCH_ADDRESS_ZIP = "SELECT * FROM address WHERE zip = ?";
    
    
    private JdbcTemplate jdbcTemplate;
    
    public AddressDaoObImpl(JdbcTemplate jdbcTemplate) {
    ...
    public List<Address> searchByLastName(String lastName) {
        return jdbcTemplate.query(SQL_SEARCH_ADDRESS_LAST_NAME, new AddressMapper(), "%"+lastName+"%");
    }

    @Override
    public List<Address> searchByCity(String city) {
        return jdbcTemplate.query(SQL_SEARCH_ADDRESS_CITY, new AddressMapper(), city);
    }

    @Override
    public List<Address> searchByState(String state) {
        return jdbcTemplate.query(SQL_SEARCH_ADDRESS_STATE, new AddressMapper(), state);
    }

    @Override
    public List<Address> searchByZip(String zip) {
        return jdbcTemplate.query(SQL_SEARCH_ADDRESS_ZIP, new AddressMapper(), zip);
    }
